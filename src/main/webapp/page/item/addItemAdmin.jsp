...
<%-- <input type="hidden" class="input-text"  id="itempicId" name="itempicId" value="${IcitemPicture.itempicId}"/> --%>
            ...
            <div class="form-aciton">
                ...
                <button class="submit-btn" id="saveItem1">审批通过</button>
                <button class="submit-btn" id="saveItem">审批不通过</button>
    ...
    <script src="<%=rootPath %>/page/item/js/addItemAdmin.js"></script>
</body>
