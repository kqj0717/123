...
public class SysOp implements Serializable {
	...
	public String toString() {
		return "SysOp [opId=" + opId + ", opName=" + opName + ", opCode=" + opCode + ", opKind=" + opKind + ", opPic="
				+ opPic + ", mobileNo=" + mobileNo + ", emailAdress=" + emailAdress + ", loginCode=" + loginCode
				+ ", loginPasswd=" + loginPasswd + ", lockFlag=" + lockFlag + ", dataState=" + dataState + ", creator="
				+ creator + ", createDate=" + createDate + ", modifier=" + modifier + ", modifyDate=" + modifyDate
				+ "]";
	}
	...
	public SysOp(Long opId, String opName, String opCode, Short opKind, String opPic, String mobileNo,
			String emailAdress, String loginCode, String loginPasswd, Short lockFlag, Short dataState, Long creator,
			Date createDate, Long modifier, Date modifyDate) {
		super();
		this.opId = opId;
		this.opName = opName;
		this.opCode = opCode;
