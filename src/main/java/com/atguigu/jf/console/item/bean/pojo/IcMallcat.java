...
public class IcMallcat {
	...
	public String toString() {
		return "IcMallcat [mallCatId=" + mallCatId + ", supMallCatId=" + supMallCatId + ", mallCatCode=" + mallCatCode
				+ ", mallCatName=" + mallCatName + ", mallCatDesc=" + mallCatDesc + ", mallCatPromotion="
				+ mallCatPromotion + ", mallCatLevel=" + mallCatLevel + ", mallCatLvlPath=" + mallCatLvlPath
				+ ", mallCatOrder=" + mallCatOrder + ", mallCatPicUrl=" + mallCatPicUrl + ", mallCatLeafFlag="
				+ mallCatLeafFlag + ", mallCatState=" + mallCatState + ", dataState=" + dataState + ", creator="
				+ creator + ", createTime=" + createTime + ", modifyer=" + modifyer + ", modifyTime=" + modifyTime
				+ "]";
	}
